																...
																<div class="form-group">
																	...
																	<div class="col-sm-8">
																		...
																		{{else if eq $data.FormType.String "select"}}
																			<select class="form-control {{$data.Field}} select2-hidden-accessible" style="width: 100%;" name="{{$data.Field}}[]"
																			multiple="" data-placeholder="{{$data.Placeholder}}" tabindex="-1" aria-hidden="true">
																				{{range $key, $v := $data.FieldOptions}}
																					<option value='{{$v.Value}}'>{{if ne $v.TextHTML ""}}{{$v.TextHTML}}{{else}}{{$v.Text}}{{end}}</option>
																				{{end}}
																			</select>
																			<span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--multiple" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1"><ul class="select2-selection__rendered"><li class="select2-search select2-search--inline"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="textbox" aria-autocomplete="list" placeholder={{$data.Placeholder}} style="width: 339px;"></li></ul></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
																			<script>
																				$('select.{{.Field}}').select2({{.OptionExt}});
																			</script>
																		{{else if eq $data.FormType.String "select_single"}}
																			<select class="form-control {{$data.Field}} select2-hidden-accessible" style="width: 100%;" name="{{$data.Field}}"
																				data-multiple="false" data-placeholder="{{$data.Placeholder}}" tabindex="-1" aria-hidden="true"
																			...
																			<span class="select2 select2-container select2-container--default" dir="ltr" style="width: 100%;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="-1" aria-labelledby="select2-parent_id-z2-container"><span class="select2-selection__rendered" id="select2-parent_id-z2-container"><span class="select2-selection__placeholder">{{$data.Placeholder}}</span></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
																			<script>
																				$('select.{{.Field}}').select2({{.OptionExt}});
																			</script>
