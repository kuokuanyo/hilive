...
<html>
	<head>
		...
		/*# sourceURL=ace/css/ace_editor.css */</style>
			...
			<script src="/admin/assets/dist/js/all.min.8425540791.js"></script><link rel="stylesheet" href="/admin/assets/dist/css/all.min.7bcc29700e.css">
					...
					<div>
						...
						<div class="box box-"}>
							...
							<div class="box-body" style=" ">
								<form id={{.FormID}} action="{{.URLRoute.NewURL}}" method="post" accept-charset="UTF-8" class="form-horizontal" pjax-container style="background-color: white;">
									<div class="box-body">
										<div class="box-body">
									...
									<input type="hidden" name="__previous_" value="{{.URLRoute.InfoURL}}">
